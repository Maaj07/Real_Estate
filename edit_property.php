...
if ($property_id > 0) {
    $property_query = mysqli_query($conn, 
        "SELECT p.*, c.name as category_name, a.name as agent_name 
         FROM properties p 
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_property'])) {
    ...
    $image_name = $property['image']; // Keep existing image by default
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] == UPLOAD_ERR_OK) {
        ...
        if (!empty($property['image']) && file_exists($target_dir . $property['image'])) {
            unlink($target_dir . $property['image']);
        }
  ...
  <div class="main1">
    ...
    <div class="form-container">
      <div class="form-header">
        <h2>Edit Property</h2>
        <span class="badge bg-secondary">ID: <?php echo $property_id; ?></span>
      </div>
      ...
      <form method="POST" enctype="multipart/form-data">
        <div class="form-row">
          <div class="form-col">
            ...
            <div class="form-group">
              ...
              <select class="form-select" id="category" name="category" required>
                ...
                <?php foreach ($categories as $category): ?>
                  <option value="<?php echo $category['id']; ?>" <?php echo ($property['category_id'] == $category['id']) ? 'selected' : ''; ?>>
            ...
            <div class="form-group">
              ...
              <select class="form-select" id="status" name="status" required>
                ...
                <option value="Not Available" <?php echo ($property['status'] == 'Not Available') ? 'selected' : ''; ?>>Not Available</option>
              </select>
            </div>
            
            <div class="form-group">
              <label for="price" class="form-label required">Price ($)</label>
              <input type="number" class="form-control" id="price" name="price" value="<?php echo $property['price']; ?>" min="0" step="0.01" required>
            </div>
          </div>
          ...
          <div class="form-col">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="pincode" name="pincode" value="<?php echo htmlspecialchars($property['pincode']); ?>" required>
            </div>
            
            <div class="form-group">
              <label for="area" class="form-label required">Area (sq. ft)</label>
              <input type="number" class="form-control" id="area" name="area" value="<?php echo $property['area']; ?>" min="0" required>
            </div>
          </div>
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="bedrooms" name="bedrooms" value="<?php echo $property['bedrooms']; ?>" min="0" required>
            </div>
            
            <div class="form-group">
              <label for="bathrooms" class="form-label required">Bathrooms</label>
              <input type="number" class="form-control" id="bathrooms" name="bathrooms" value="<?php echo $property['bathrooms']; ?>" min="0" required>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="image-preview-container">
                ...
                <span class="current-image-text">New Image Preview:</span>
                <div class="image-preview">
                  <img id="newImagePreview" src="#" alt="New image preview" style="display: none;">
                  <span id="previewText">Select a new image to preview</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="action-buttons">
          <div>
            ...
            <a href="property_list.php?delete_id=<?php echo $property_id; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this property? This action cannot be undone.');">
