...
$property_query = mysqli_query($conn, "SELECT p.*, c.name as category_name FROM properties p 
                                      ...
                                      WHERE p.status = 'Available' AND LOWER(c.name) = 'buy' 
                                      ORDER BY p.id DESC");
if ($property_query) {
...
<html lang="en">
  <head>
    ...
    <title>Buy - <?php echo $_SESSION['username']?> </title>
 ...
 <!-- Header Section -->
  <div class="Buy-header">
    ...
    <h1 class="fw-bold"><I class="text-warning">Buy</I></h1>
  </div>
