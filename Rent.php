...
$property_query = mysqli_query($conn, "SELECT p.*, c.name as category_name FROM properties p 
                                      ...
                                      WHERE p.status = 'Available' AND LOWER(c.name) = 'rent' 
                                      ORDER BY p.id DESC");
if ($property_query) {
...
<html lang="en">
  <head>
    ...
    <title>Rent - <?php echo $_SESSION['username']?> </title>
    ...
    <style>
     .Rent-header {
        ...
        url("/REAL_ESTATE/UserInterface/Img/Rent1.jpg") no-repeat center center;
 ...
 <!-- Header Section -->
  <div class="Rent-header">
    ...
    <h1 class="fw-bold"><I class="text-warning">Rent</I></h1>
  </div>
  ...
  <div class="container py-5">
    ...
    <div class="row g-4">
        <?php if(count($rent_properties) > 0): ?>
